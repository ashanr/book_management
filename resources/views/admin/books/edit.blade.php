    ...
    <div class="container mx-auto mt-4">
        ...
        <form method="POST" action="{{ route('admin.books.update', ['id' => $book->id]) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" class="form-input w-full rounded-md border-gray-300"
                    value="{{ $book->title }}">
                @if ($errors->has('title'))
            ...
            <div class="mb-4">
                ...
                <input type="text" name="author" id="author" class="form-input w-full rounded-md border-gray-300"
                    value="{{ $book->author }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="isbn" id="isbn" class="form-input w-full rounded-md border-gray-300"
                    value="{{ $book->isbn }}">
                @if ($errors->has('isbn'))
            ...
            <div class="mt-4">
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Update Book</button>
            </div>
        </form>
    </div>
@endsection
